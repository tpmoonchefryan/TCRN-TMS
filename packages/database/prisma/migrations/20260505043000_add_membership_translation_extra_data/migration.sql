-- Add JSONB metadata storage for membership type/level translation maps.
-- Applies to tenant_template and existing tenant schemas so translation management can persist non-legacy locales.
