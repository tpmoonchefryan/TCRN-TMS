...
export const RBAC_CANONICAL_ACTIONS = ['read', 'write', 'delete', 'execute', 'admin'] as const;
...
export const RBAC_ROLE_POLICY_EFFECTS = ['grant', 'deny'] as const;
...
export const RBAC_RESOURCES = [
  resource(
    ...
    'platform',
    {
      name: {
        ...
        zh_HANT: '租户管理',
        ja: 'テナント管理',
        ko: 'Tenant Management',
        fr: 'Tenant Management',
      },
    },
  ...
  resource(
    ...
    'user',
    {
      name: { en: 'Role', zh_HANS: '角色', zh_HANT: '角色', ja: 'ロール', ko: 'Role', fr: 'Role' },
    },
    ['read', 'write', 'delete', 'admin'],
    50
  ),
  ...
  resource(
    ...
    {
      name: {
        en: 'Customer Membership',
        zh_HANS: '会员记录',
        zh_HANT: '会员记录',
        ja: 'メンバーシップ',
        ko: 'Customer Membership',
        fr: 'Customer Membership',
      },
    },
    ['read', 'write', 'admin'],
    80
  ...
  resource(
    ...
    {
      name: {
        en: 'PII Service Config',
        zh_HANS: 'PII服务配置',
        zh_HANT: 'PII服务配置',
        ja: 'PIIサービス設定',
        ko: 'PII Service Config',
        fr: 'PII Service Config',
      },
    },
    ['read', 'write', 'admin'],
    110
  ...
  resource(
    ...
    {
      name: {
        en: 'Config Dictionary',
        zh_HANS: '配置字典',
        zh_HANT: '配置字典',
        ja: '設定辞書',
        ko: 'Config Dictionary',
        fr: 'Config Dictionary',
      },
    },
    ['read', 'write', 'admin'],
    130
  ...
  resource(
    ...
    {
      name: {
        en: 'Customer Status Config',
        zh_HANS: '客户状态配置',
        zh_HANT: '客户状态配置',
        ja: '顧客ステータス設定',
        ko: 'Customer Status Config',
        fr: 'Customer Status Config',
      },
    },
    ['read', 'write', 'admin'],
    140
  ...
  resource(
    ...
    {
      name: {
        en: 'Membership Config',
        zh_HANS: '会员配置',
        zh_HANT: '会员配置',
        ja: 'メンバーシップ設定',
        ko: 'Membership Config',
        fr: 'Membership Config',
      },
    },
    ['read', 'write', 'admin'],
    150
  ...
  resource(
    ...
    {
      name: {
        en: 'Platform Registry',
        zh_HANS: '平台注册表',
        zh_HANT: '平台注册表',
        ja: 'プラットフォームレジストリ',
        ko: 'Platform Registry',
        fr: 'Platform Registry',
      },
    },
    ['read', 'write', 'admin'],
    160
  ...
  resource(
    ...
    'config',
    {
      name: {
        ...
        zh_HANT: '平台设置',
        ja: 'プラットフォーム設定',
        ko: 'Platform Settings',
        fr: 'Platform Settings',
      },
    },
    ['read', 'write', 'admin'],
    170
  ...
  resource(
    ...
    {
      name: {
        en: 'Public Presence Document',
        zh_HANS: 'Public Presence 文档',
        zh_HANT: 'Public Presence 文档',
        ja: 'パブリックプレゼンス文書',
        ko: 'Public Presence Document',
        fr: 'Public Presence Document',
      },
    },
    ['read', 'write', 'admin'],
    182
  ...
  resource(
    ...
    {
      name: {
        en: 'Public Presence Review',
        zh_HANS: 'Public Presence 审核',
        zh_HANT: 'Public Presence 审核',
        ja: 'パブリックプレゼンスレビュー',
        ko: 'Public Presence Review',
        fr: 'Public Presence Review',
      },
    },
    ['read', 'write', 'execute', 'admin'],
    184
  ...
  resource(
    ...
    {
      name: {
        en: 'Public Presence Publish',
        zh_HANS: 'Public Presence 发布',
        zh_HANT: 'Public Presence 发布',
        ja: 'パブリックプレゼンス公開',
        ko: 'Public Presence Publish',
        fr: 'Public Presence Publish',
      },
    },
    ['write', 'execute', 'admin'],
    186
  ...
  resource(
    ...
    {
      name: {
        en: 'Public Presence Rollback',
        zh_HANS: 'Public Presence 回滚',
        zh_HANT: 'Public Presence 回滚',
        ja: 'パブリックプレゼンスロールバック',
        ko: 'Public Presence Rollback',
        fr: 'Public Presence Rollback',
      },
    },
    ['write', 'execute', 'admin'],
    188
  ...
  resource(
    ...
    {
      name: {
        en: 'Public Presence Validation',
        zh_HANS: 'Public Presence 校验',
        zh_HANT: 'Public Presence 校验',
        ja: 'パブリックプレゼンス検証',
        ko: 'Public Presence Validation',
        fr: 'Public Presence Validation',
      },
    },
    ['read', 'write', 'execute', 'admin'],
    190
  ...
  resource(
    ...
    {
      name: {
        en: 'Public Presence Audit',
        zh_HANS: 'Public Presence 审计',
        zh_HANT: 'Public Presence 审计',
        ja: 'パブリックプレゼンス監査',
        ko: 'Public Presence Audit',
        fr: 'Public Presence Audit',
      },
    },
    ['read', 'admin'],
    192
  ...
  resource(
    ...
    {
      name: {
        en: 'Public Presence AI Patch',
        zh_HANS: 'Public Presence AI 修补',
        zh_HANT: 'Public Presence AI 修补',
        ja: 'パブリックプレゼンスAIパッチ',
        ko: 'Public Presence AI Patch',
        fr: 'Public Presence AI Patch',
      },
    },
    ['execute', 'admin'],
    194
  ...
  resource(
    ...
    {
      name: {
        en: 'Integration Adapter',
        zh_HANS: '集成适配器',
        zh_HANT: '集成适配器',
        ja: '連携アダプター',
        ko: 'Integration Adapter',
        fr: 'Integration Adapter',
      },
    },
    ['read', 'write', 'delete', 'admin'],
    210
  ...
  resource(
    ...
    'security',
    {
      name: {
        ...
        zh_HANT: '外部屏蔽名单',
        ja: '外部ブロックリスト',
        ko: 'External Blocklist',
        fr: 'External Blocklist',
      },
    },
    ['read', 'write', 'delete', 'admin'],
    260
  ...
  resource(
    ...
    'compliance',
    {
      name: {
        ...
        zh_HANT: '合规报表',
        ja: 'コンプライアンスレポート',
        ko: 'Compliance Report',
        fr: 'Compliance Report',
      },
    },
    ['read'],
    310
...
export const RBAC_RESOURCE_MAP: ReadonlyMap<RbacResourceCode, (typeof RBAC_RESOURCES)[number]> =
  new Map(RBAC_RESOURCES.map((definition) => [definition.code, definition]));

export function getRbacResourceDefinition(
  resourceCode: string
): (typeof RBAC_RESOURCES)[number] | undefined {
...
export function getRbacRoleWorkspaceAvailability(roleCode: string): RbacRoleWorkspaceAvailability {
...
export const RBAC_POLICY_DEFINITIONS: readonly RbacPolicyDefinition[] = (() => {
  ...
  return Array.from(policies.values()).sort((left, right) => {
    if (left.resourceCode === right.resourceCode) {
      return (
        RBAC_CANONICAL_ACTIONS.indexOf(left.action) - RBAC_CANONICAL_ACTIONS.indexOf(right.action)
      );
    }
...
export function normalizePermissionAction<T extends string>(
  ...
  return (RBAC_ACTION_ALIASES[action as PermissionActionAlias] ??
    action) as T extends PermissionActionInput ? PermissionAction : string;
}
