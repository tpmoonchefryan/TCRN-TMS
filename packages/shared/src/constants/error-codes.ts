...
export const ErrorCodes = {
  ...
  TENANT_FEATURES_RETIRED: 'TENANT_FEATURES_RETIRED',
  TENANT_CAPABILITY_INVALID: 'TENANT_CAPABILITY_INVALID',
  TENANT_CAPABILITY_DISABLED: 'TENANT_CAPABILITY_DISABLED',
  ...
  TALENT_LIFECYCLE_CONFLICT: 'TALENT_LIFECYCLE_CONFLICT',
  TALENT_PUBLISH_BLOCKED: 'TALENT_PUBLISH_BLOCKED',
  TALENT_NOT_PUBLISHED: 'TALENT_NOT_PUBLISHED',
  ...
  SYS_CUSTOM_DOMAIN_REGISTRY_UNAVAILABLE: 'SYS_CUSTOM_DOMAIN_REGISTRY_UNAVAILABLE',
...
export const ErrorHttpStatus: Record<ErrorCode, number> = {
  ...
  [ErrorCodes.TENANT_FEATURES_RETIRED]: 400,
  [ErrorCodes.TENANT_CAPABILITY_INVALID]: 400,
  [ErrorCodes.TENANT_CAPABILITY_DISABLED]: 403,
  ...
  [ErrorCodes.TALENT_LIFECYCLE_CONFLICT]: 409,
  [ErrorCodes.TALENT_PUBLISH_BLOCKED]: 409,
  [ErrorCodes.TALENT_NOT_PUBLISHED]: 403,
  ...
  [ErrorCodes.SYS_CUSTOM_DOMAIN_REGISTRY_UNAVAILABLE]: 503,
