...
export const PublicPresenceTemplateIdSchema = z.enum(
  PUBLIC_PRESENCE_TEMPLATE_IDS,
);
export const PublicPresenceStageSectionKindSchema = z.enum(
  PUBLIC_PRESENCE_STAGE_SECTION_KINDS,
);
export const PublicPresenceValidationSeveritySchema = z.enum(
  PUBLIC_PRESENCE_VALIDATION_SEVERITIES,
);
export const PublicPresenceValidationStateSchema = z.enum(
  PUBLIC_PRESENCE_VALIDATION_STATES,
);
export const PublicPresenceValidationModeSchema = z.enum(
  PUBLIC_PRESENCE_VALIDATION_MODES,
);
export const PublicPresenceDocumentStateSchema = z.enum(
  PUBLIC_PRESENCE_DOCUMENT_STATES,
);
export const PublicPresenceFieldProvenanceSchema = z.enum(
  PUBLIC_PRESENCE_FIELD_PROVENANCES,
);
export const PublicPresenceHashAlgorithmSchema = z.enum(
  PUBLIC_PRESENCE_HASH_ALGORITHMS,
);
export const PublicPresenceRevealPhaseSchema = z.enum(
  PUBLIC_PRESENCE_REVEAL_PHASES,
);
export const PublicPresenceWorkflowEventTypeSchema = z.enum(
  PUBLIC_PRESENCE_WORKFLOW_EVENT_TYPES,
);
export const PublicPresencePhaseVisibilitySchema = z.enum(
  PUBLIC_PRESENCE_PHASE_VISIBILITIES,
);
export const PublicPresenceFallbackPolicySchema = z.enum(
  PUBLIC_PRESENCE_FALLBACK_POLICIES,
);
...
export const PublicPresenceProjectedMediaKindSchema = z.enum(
  PUBLIC_PRESENCE_PROJECTED_MEDIA_KINDS,
);
...
export const PublicPresenceFieldValueSchema = z.object({
  value: z.unknown(),
...
export const PublicPresenceComponentNodeSchema = z.object({
...
export const PublicPresenceSectionNodeSchema = z.object({
  id: z.string().min(1).max(128),
...
export const PublicPresenceMetadataSchema = z.object({
  title: z.string().max(255).optional(),
...
export const PublicPresencePersonaKitSchema = z.object({
  accentTone: z.string().max(64).optional(),
  campaignLabel: z.string().max(128).optional(),
  tagline: z.string().max(255).optional(),
}).strict();

export const PublicPresenceDocumentSchema = z.object({
...
export const PublicPresenceProfileCardPropsSchema = z.object({
...
export const PublicPresenceSocialLinksPropsSchema = z.object({
...
export const PublicPresenceImageGalleryPropsSchema = z.object({
...
export const PublicPresenceVideoEmbedPropsSchema = z.object({
...
export const PublicPresenceRichTextPropsSchema = z.object({
  contentHtml: z.string().min(1).max(12000),
  textAlign: z.enum(['left', 'center', 'right']).optional(),
}).strict();

export const PublicPresenceLinkButtonPropsSchema = z.object({
...
export const PublicPresenceMarshmallowWidgetPropsSchema = z.object({
...
export const PublicPresenceSchedulePropsSchema = z.object({
  title: z.string().max(255).optional(),
  weekOf: z.string().max(64).optional(),
  events: z.array(ScheduleEventSchema).optional(),
}).strict();

export const PublicPresenceMusicPlayerPropsSchema = z.object({
...
export const PublicPresenceLiveStatusPropsSchema = z.object({
...
export const PublicPresenceDividerPropsSchema = z.object({
  style: z.enum(['solid', 'dashed', 'dotted']).optional(),
  spacing: z.enum(['small', 'medium', 'large']).optional(),
}).strict();

export const PublicPresenceSpacerPropsSchema = z.object({
  height: z.enum(['small', 'medium', 'large', 'xlarge']).optional(),
}).strict();

export const PublicPresenceBilibiliDynamicPropsSchema = z.object({
...
const AgencyNoteSchema = z.object({
  kind: z.enum([
    'announcement',
    'campaignCaveat',
    'safetyNotice',
...
const FanActionSchema = z.object({
  slot: z.enum([
    'follow',
    'notify',
    'currentAction',
...
export const PublicPresenceFirstEncounterFieldSchema = z.object({
...
export const PublicPresenceCountdownRevealFieldSchema = z.object({
...
export const PublicPresenceAgencyNotesFieldSchema = z.object({
  notes: PublicPresenceFieldValueSchema.extend({
    value: z.array(AgencyNoteSchema),
  }),
}).strict();

export const PublicPresenceFanActionsFieldSchema = z.object({
...
export const PublicPresenceValidationIssueSchema = z.object({
...
export const PublicPresenceValidationSnapshotSchema = z.object({
  ...
  fallbackDecisions: z.array(z.object({
    path: z.array(z.string().min(1).max(255)),
...
export const PublicPresenceProjectedMediaSchema = z.object({
  id: z.string().min(1).max(128),
...
export const PublicPresenceProjectionMetadataSchema = z.object({
...
export const PublicPresenceProjectionRouteSchema = z.object({
  canonicalPath: z.string().min(1).max(512),
...
const PublicPresenceProjectedSectionBaseSchema = z.object({
  id: z.string().min(1).max(128),
...
const PublicPresenceProjectedHeroSectionSchema =
...
const PublicPresenceProjectedScheduleEventSchema = z.object({
  day: z.string().min(1).max(32),
  time: z.string().min(1).max(64),
  title: z.string().min(1).max(255),
}).strict();
...
const PublicPresenceProjectedDividerSectionSchema =
  PublicPresenceProjectedSectionBaseSchema.extend({
...
const PublicPresenceProjectedSpacerSectionSchema =
  PublicPresenceProjectedSectionBaseSchema.extend({
...
export const PublicPresenceProjectedSectionSchema = z.discriminatedUnion(
  'sectionType',
  [
...
export const PublicPresenceProjectionSchema = z.object({
...
export const PublicPresencePublicProjectionRouteSchema = z.object({
  canonicalPath: z.string().min(1).max(512),
  legacyPath: z.string().max(255).nullable(),
  tenantCode: z.string().max(128).nullable(),
  talentCode: z.string().max(128).nullable(),
...
export const PublicPresencePublicProjectionSchema = z.object({
  projectionSchemaVersion: z.literal(PUBLIC_PRESENCE_PROJECTION_SCHEMA_VERSION),
  resolvedRevealPhase: PublicPresencePhaseVisibilitySchema,
...
export const PublicPresenceProjectionEventSchema = z.object({
