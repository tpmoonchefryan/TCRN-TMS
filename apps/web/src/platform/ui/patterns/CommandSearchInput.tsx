  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <input
        ...
        value={currentValue}
        disabled={disabled}
        className="block w-full rounded-lg border border-slate-200 bg-slate-50/50 py-2 pr-12 pl-10 text-sm transition-colors hover:bg-slate-50 focus:border-transparent focus:bg-white focus:ring-2 focus:ring-indigo-500 focus:outline-none disabled:cursor-not-allowed disabled:opacity-60"
