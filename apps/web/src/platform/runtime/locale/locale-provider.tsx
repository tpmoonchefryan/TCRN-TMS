...
export interface UiLocaleCopy {
  ...
  publicHomepage: {
    ...
    publicHomepageDescriptionFallback: string;
    publicHomepagePreviewSuffix: string;
    publicHomepageTitleFallback: string;
...
const LOCALE_OPTIONS: Array<{ code: SupportedUiLocale; label: string }> = SUPPORTED_UI_LOCALES.map(
...
const enUiLocaleCopy: UiLocaleCopy = {
  ...
  auth: {
    login: {
      ...
      passwordResetDescription: 'Your account requires a password change before you can continue.',
  ...
  publicHomepage: {
    avatarSuffix: 'avatar',
    badge: 'Official Fan Page',
    bilibiliDescription: 'This block links to the source Bilibili profile.',
    bilibiliDynamic: 'Bilibili Dynamic',
    bilibiliFeedSummary: 'Latest {count} updates{refresh}',
    ...
    publicHomepageDescriptionFallback: 'Official fan page',
    publicHomepagePreviewSuffix: 'fan page preview',
    publicHomepageTitleFallback: 'TCRN TMS',
    publishedBlocksLabel: 'Published blocks',
    refreshSuffix: ' · refreshes every {seconds}s',
    schedule: 'Schedule',
    socialLinks: 'Social Links',
    timezoneLabel: 'Timezone',
    unavailableDescription:
      'This fan page is not live yet, is not reachable right now, or has been turned off.',
    unavailableTitle: 'Fan page unavailable',
  ...
  publicMarshmallow: {
    ...
    loadedCountLabel: 'loaded so far',
    loading: 'Loading public marshmallow',
    messageFeedFailed: 'The public message feed failed to load.',
    messageLabel: 'Message',
    messagePlaceholder: 'Write your message here',
    missingCaptchaDisabledNotice: 'Submission is temporarily unavailable. Please try again later.',
    missingCaptchaError: 'Submission is temporarily unavailable. Please try again later.',
...
const zhHansUiLocaleCopy: UiLocaleCopy = {
  ...
  publicHomepage: {
    ...
    bilibiliFeedSummary: '最近 {count} 条更新{refresh}',
    ...
    loading: '正在加载粉丝页',
    marshmallow: '棉花糖',
    marshmallowDescription: '当前主页包含一个棉花糖区块。公开消息可通过专用的 /m/<path> 页面访问。',
    music: '音乐',
    ...
    profileAvatar: '资料头像',
    publicHomepageDescriptionFallback: '官方粉丝页',
    publicHomepagePreviewSuffix: '粉丝页预览',
    publicHomepageTitleFallback: 'TCRN TMS',
    publishedBlocksLabel: '已发布区块',
    refreshSuffix: ' · 每 {seconds} 秒更新',
    schedule: '日程',
    socialLinks: '社交链接',
    timezoneLabel: '时区',
    unavailableDescription: '当前粉丝页尚未上线、暂时不可达，或已被关闭。',
    unavailableTitle: '粉丝页不可用',
  ...
  publicMarshmallow: {
    ...
    loadedCountLabel: '已加载至今',
    loading: '正在加载公开棉花糖',
    messageFeedFailed: '公开消息流加载失败。',
    messageLabel: '消息内容',
    messagePlaceholder: '在这里写下你的消息',
    missingCaptchaDisabledNotice: '提交暂时不可用。请稍后重试。',
...
const jaUiLocaleCopy: UiLocaleCopy = {
  ...
  publicHomepage: {
    avatarSuffix: 'アバター',
    badge: '公式ファンページ',
    bilibiliDescription: 'このブロックから元の Bilibili プロフィールへ移動できます。',
    bilibiliDynamic: 'Bilibili 動態',
    bilibiliFeedSummary: '最近の {count} 件の更新{refresh}',
    ...
    publicHomepageDescriptionFallback: '公式ファンページ',
    publicHomepagePreviewSuffix: 'ファンページプレビュー',
    publicHomepageTitleFallback: 'TCRN TMS',
    publishedBlocksLabel: '公開中ブロック数',
    refreshSuffix: ' · {seconds} 秒ごとに反映',
    schedule: 'スケジュール',
    socialLinks: 'ソーシャルリンク',
    timezoneLabel: 'タイムゾーン',
    unavailableDescription:
      'このファンページはまだ公開されていないか、現在は到達できないか、停止されています。',
    unavailableTitle: 'ファンページを利用できません',
  ...
  publicMarshmallow: {
    ...
    loadedCountLabel: 'ここまで読み込み済み',
    loading: '公開マシュマロを読み込み中',
    messageFeedFailed: '公開メッセージフィードの読み込みに失敗しました。',
    messageLabel: 'メッセージ',
    messagePlaceholder: 'ここにメッセージを入力してください',
    missingCaptchaDisabledNotice: '送信は一時的に利用できません。後でもう一度お試しください。',
    missingCaptchaError: '送信は一時的に利用できません。後でもう一度お試しください。',
  ...
  customerManagement: {
    ...
    description: 'このタレントに紐づく顧客、会員可視性、ライフサイクル状態を確認します。',
    directCustomerRecord: '直接顧客レコード',
    emptyDescription:
      '現在の検索語またはメンバーシップフィルターを変更して、表示対象の顧客集合を広げてください。',
...
function extendUiLocaleCopy(base: UiLocaleCopy, overrides: UiLocaleCopyOverrides): UiLocaleCopy {
  return {
    common: {
      ...base.common,
      ...overrides.common,
...
const LOCALE_COPY: Record<SupportedUiLocale, UiLocaleCopy> = {
  ...
  zh_HANT: extendUiLocaleCopy(zhHansUiLocaleCopy, {
    ...
    publicHomepage: {
      ...
      bilibiliDynamic: 'Bilibili 動態',
      bilibiliFeedSummary: '最近 {count} 則更新{refresh}',
      ...
      loading: '正在載入粉絲頁',
      marshmallow: '棉花糖',
      marshmallowDescription: '此主頁包含一個棉花糖區塊。公開訊息可透過專用的 /m/<path> 頁面查看。',
      music: '音樂',
      ...
      profileAvatar: '資料頭像',
      publicHomepageDescriptionFallback: '官方粉絲頁',
      publicHomepagePreviewSuffix: '粉絲頁預覽',
      publicHomepageTitleFallback: 'TCRN TMS',
      ...
      socialLinks: '社群連結',
      timezoneLabel: '時區',
      unavailableDescription: '目前粉絲頁尚未上線、暫時不可達，或已被關閉。',
      unavailableTitle: '粉絲頁不可用',
    ...
    publicMarshmallow: {
      ...
      loadedCountLabel: '目前已載入',
      loading: '正在載入公開棉花糖',
      messageFeedFailed: '公開訊息流載入失敗。',
      messageLabel: '訊息內容',
      messagePlaceholder: '在這裡寫下你的訊息',
      missingCaptchaDisabledNotice: '提交暫時無法使用。請稍後再試。',
  ...
  ko: extendUiLocaleCopy(enUiLocaleCopy, {
    ...
    publicHomepage: {
      ...
      bilibiliFeedSummary: '최근 업데이트 {count}개{refresh}',
      ...
      publicHomepageDescriptionFallback: '공식 팬 페이지',
      publicHomepagePreviewSuffix: '팬 페이지 미리보기',
      publicHomepageTitleFallback: 'TCRN TMS',
      publishedBlocksLabel: '게시된 블록',
      refreshSuffix: ' · {seconds}초마다 반영',
      schedule: '일정',
      socialLinks: '소셜 링크',
      timezoneLabel: '시간대',
      unavailableDescription:
        '이 팬 페이지는 아직 공개되지 않았거나, 현재 접근할 수 없거나, 비활성화되었습니다.',
      unavailableTitle: '팬 페이지를 사용할 수 없습니다',
    ...
    publicMarshmallow: {
      ...
      unavailableDescription:
        '이 공개 마시멜로 페이지는 아직 게시되지 않았거나, 비활성화되었거나, 현재 접근할 수 없습니다.',
  ...
  fr: extendUiLocaleCopy(enUiLocaleCopy, {
    ...
    tenantGovernance: {
      ...
      titles: {
        ...
        profile: 'Profil',
        security: 'Sécurité',
        subsidiarySettings: 'Paramètres du périmètre',
        tenantSettings: 'Paramètres du tenant',
        userManagement: 'Gestion des utilisateurs',
    ...
    publicHomepage: {
      ...
      loading: 'Chargement de la page fan',
      marshmallow: 'Marshmallow',
      marshmallowDescription:
      ...
      publicHomepageDescriptionFallback: 'Page fan officielle',
      publicHomepagePreviewSuffix: 'aperçu de la page fan',
      publicHomepageTitleFallback: 'TCRN TMS',
      publishedBlocksLabel: 'Blocs publiés',
      refreshSuffix: ' · mises à jour toutes les {seconds} s',
      schedule: 'Planning',
      socialLinks: 'Liens sociaux',
      timezoneLabel: 'Fuseau horaire',
      unavailableDescription:
        'Cette page fan n’est pas encore en ligne, n’est pas accessible pour le moment ou a été désactivée.',
      unavailableTitle: 'Page fan indisponible',
    ...
    publicMarshmallow: {
      ...
      emptyDescription:
        'Les questions publiques approuvées apparaîtront ici une fois publiées par le talent.',
      ...
      loadedCountLabel: 'chargé(s) jusqu’ici',
      loading: 'Chargement du marshmallow public',
      messageFeedFailed: 'Le flux de messages publics n’a pas pu être chargé.',
      messageLabel: 'Message',
      messagePlaceholder: 'Écrivez votre message ici',
      missingCaptchaDisabledNotice: 'L’envoi est temporairement indisponible. Réessayez plus tard.',
      ...
      unavailableDescription:
        'Cette page marshmallow publique n’est pas publiée, pas activée ou actuellement inaccessible.',
...
export function UiLocaleProvider({
  ...
  const locale =
    overrideLocale ?? normalizeUiLocale(session?.user.preferredLanguage) ?? browserLocale;
