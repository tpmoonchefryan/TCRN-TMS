...
const enUiLocaleCopy: UiLocaleCopy = {
    ...
    publicHomepage: {
      ...
      unavailableDescription: 'This fan page is not live yet, is not reachable right now, or has been turned off.',
...
const jaUiLocaleCopy: UiLocaleCopy = {
    ...
    publicHomepage: {
      ...
      unavailableDescription: 'このファンページはまだ公開されていないか、現在は到達できないか、停止されています。',
...
const LOCALE_COPY: Record<SupportedUiLocale, UiLocaleCopy> = {
  ...
  ko: extendUiLocaleCopy(enUiLocaleCopy, {
    ...
    publicHomepage: {
      ...
      socialLinks: '소셜 링크',
      timezoneLabel: '시간대',
      unavailableDescription: '이 팬 페이지는 아직 공개되지 않았거나, 현재 접근할 수 없거나, 비활성화되었습니다.',
  ...
  fr: extendUiLocaleCopy(enUiLocaleCopy, {
    ...
    publicHomepage: {
      ...
      unavailableDescription: 'Cette page fan n’est pas encore en ligne, n’est pas accessible pour le moment ou a été désactivée.',
