...
export async function PublicMarshmallowTermsScreen({
  params,
}: {
  ...
  const defaultTermsContent = t.raw('defaultTermsMarkdown') as string;
  const termsContent = config.terms?.[localeKey] || config.terms?.en || defaultTermsContent;
