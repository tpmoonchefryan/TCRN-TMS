...
const COPY = {
  en: {
    ...
    actions: {
      ...
      openConfig: 'Configure mailbox',
      closeConfigDrawer: 'Close marshmallow configuration drawer',
    ...
    config: {
      ...
      turnstile: {
        title: 'Turnstile runtime status',
        description:
          'Turnstile keys are deployment configuration. This panel only shows whether the public widget key and server verification secret are present.',
  ...
  ja: {
    ...
    actions: {
      ...
      openConfig: 'メールボックスを設定',
      closeConfigDrawer: 'マシュマロ設定ドロワーを閉じる',
    ...
    config: {
      ...
      turnstile: {
        title: 'Turnstile ランタイム状態',
        description:
          'Turnstile キーはデプロイ設定です。このパネルでは公開ウィジェットキーとサーバー検証シークレットの有無だけを表示します。',
        summaryLabel: 'Turnstile',
        ready: '準備完了',
        unavailable: '送信不可',
        notRequired: '不要',
