  ...
  ja: {
    ...
    sections: {
      ...
      blocklistEditor: {
        ...
        newRule: 'ルールを追加',
        createRule: 'ルールを作成',
        closeButtonAriaLabel: '遮断ルールドロワーを閉じる',
        saveChanges: '変更を保存',
        creating: '作成中…',
        saving: '保存中…',
      ...
      externalEditor: {
        ...
        newPattern: 'パターンを追加',
        create: 'パターンを作成',
        closeButtonAriaLabel: '外部パターンドロワーを閉じる',
        update: '変更を保存',
        creating: '作成中…',
        saving: '保存中…',
      ...
      ipRules: {
        ...
        create: 'IP ルールを作成',
        closeButtonAriaLabel: 'IP ルールドロワーを閉じる',
        creating: '作成中…',
        probeTitle: 'ポリシー確認',
      ...
      runtimeSignals: {
        ...
        policyProbeHint: '候補 IP のアクセス結果を確認します。ポリシールールは変更しません。',
