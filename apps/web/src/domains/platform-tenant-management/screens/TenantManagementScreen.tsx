        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div className="flex flex-wrap items-end gap-3">
            ...
            <label className="relative min-w-[18rem]">
              ...
              <input
                type="search"
                aria-label={managementCopy.searchPlaceholder}
                value={search}
                onChange={(event) =>
                  applyQueryState({
                ...
                className="w-full rounded-full border border-slate-200 bg-white/85 py-2 pr-4 pl-10 text-sm text-slate-900 transition outline-none focus:border-slate-400"
              />
            </label>
          </div>
