...
export function SettingsCategoryWorkbench({
  ...
  return (
    <div className="grid min-w-0 gap-5 lg:grid-cols-[15rem_minmax(0,1fr)] lg:items-start">
      <nav className="min-w-0 border-b border-slate-200 pb-3 lg:border-b-0 lg:border-r lg:pb-0 lg:pr-4" aria-label={ariaLabel}>
        <div className="flex min-w-0 gap-2 overflow-x-auto pb-1 lg:flex-col lg:overflow-visible lg:pb-0" onKeyDown={handleCategoryNavKeyDown}>
            ...
            return (
              <button
                ...
                className={`
                  ...
                  focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 lg:w-full
                  ${isActive
