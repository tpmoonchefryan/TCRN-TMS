...
import { PiiServiceConfigController, ProfileStoreController } from './controllers';
...
import { PiiServiceConfigService, ProfileStoreService } from './services';

@Module({
  controllers: [PiiServiceConfigController, ProfileStoreController],
  providers: [
  ...
  exports: [PiiServiceConfigService, ProfileStoreService],
})
